...
class Calender(object):
    ...
    def _make_date_obj(self, year, month, day):
        """Creates a date object"""
        return self._date.replace(year, month, day)
    ...
    def set_day(self, day):
        ...
        date_obj = self._make_date_obj(self.get_year(), self.get_month(), day)
        self._day = date_obj.strftime("%A") # get the correct day which corresponds to the day number.
